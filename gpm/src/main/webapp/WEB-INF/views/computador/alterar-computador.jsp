						...
						<div class="form-group">
							...
							<div class="form-group" ng-class="{ 'has-error' : userForm.modelo.$invalid && !userForm.modelo.$pristine }" >
								...
								<div class="col-sm-3">
										...
										autofocus="autofocus" ng-model="nome" required  ng-init="nome='${computador.nome}'"/>
							...
							<div  class="form-group"  ng-class="{ 'has-error' : userForm.descricao.$invalid && !userForm.descricao.$pristine }">		
								...
								<div class="col-sm-3">
										...
										autofocus="autofocus" ng-model="descricao" required  ng-init="descricao='${computador.descricao}'"/>
							...
							<div class="form-group" ng-class="{ 'has-error' : userForm.tipo.$invalid && !userForm.tipo.$pristine }" >
								...
								<div class="col-sm-3">
									<button type="button" class="btn btn-primary" ng-disabled="userForm.$invalid" ng-click="alterarComputador(userForm.$valid)" >Alterar Cadastro</button>
								</div>
							</div>
