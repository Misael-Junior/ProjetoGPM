					...
					<div class="panel-body">
						...
						<div class="form-group"
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" id="setor" name="setor"
									placeholder="Ex: Diagnósticos" ng-minlength="3"
									ng-maxlength="20" required autofocus="autofocus"
									ng-model="setor" />
								<p
								...
								<p ng-show="userForm.setor.$error.minlength" class="help-block">Setor
									mínimo de 3 caracteres.</p>
								<p ng-show="userForm.setor.$error.maxlength" class="help-block">Setor
						...
						<div class="form-group"
							...
							<div class="col-sm-2">
								...
								<p ng-show="userForm.ip.$invalid && !userForm.ip.$pristine"
									class="help-block">Setor é Obrigatório.</p>
								<p ng-show="userForm.ip.$error.minlength" class="help-block">Setor
									mínimo de 12 caracteres.</p>
								<p ng-show="userForm.ip.$error.maxlength" class="help-block">Setor
									máximo de 20 caracteres.</p>
							</div>
						</div>
						...
						<div class="form-group"
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" id="ramal" name="ramal"
									placeholder="Ramal" required ng-minlength="4" ng-maxlength="10"
