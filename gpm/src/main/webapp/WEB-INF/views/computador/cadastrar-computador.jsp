						...
						<div class="panel-body">
							...
							<div  class="form-group"  ng-class="{ 'has-error' : userForm.descricao.$invalid && !userForm.descricao.$pristine }">		
								...
								<div class="col-sm-3">
										...
										autofocus="autofocus" ng-model="descricao" ng-minlength="3" ng-maxlength="30"required/>
										<p ng-show="userForm.descricao.$invalid && !userForm.descricao.$pristine" class="help-block"></p>
										<p ng-show="userForm.descricao.$invalid && !userForm.descricao.$pristine" class="help-block">Descrição é Obrigatório.</p>
										<p ng-show="userForm.descricao.$error.minlength" class="help-block">Descrição mínimo de 3 caracteres.</p>
                						<p ng-show="userForm.descricao.$error.maxlength" class="help-block">Descrição máximo de 30 caracteres.</p>
								</div>	</div>
							...
							<div class="form-group" ng-class="{ 'has-error' : userForm.gap_tomb.$invalid && !userForm.gap_tomb.$pristine }" >
								...
								<div class="col-sm-2">
									<input type="text" class="form-control" id="gap_tomb"
										name="gap_tomb" placeholder="(Patrimônio)" ng-minlength="3" ng-maxlength="30" required
										autofocus="autofocus" ng-model="gap_tomb"/>
										<p ng-show="userForm.gap_tomb.$invalid && !userForm.gap_tomb.$pristine" class="help-block"></p>
										<p ng-show="userForm.gap_tomb.$invalid && !userForm.gap_tomb.$pristine" class="help-block">Tombamento é Obrigatório.</p>
										<p ng-show="userForm.gap_tomb.$error.minlength" class="help-block">Descrição mínimo de 3 caracteres.</p>
                						<p ng-show="userForm.gap_tomb.$error.maxlength" class="help-block">Descrição máximo de 20 caracteres.</p>
								</div>
								</div>
								...
								<div class="col-sm-2">
									<input type="text" class="form-control" id="setor"
										name="setor" placeholder="Ex: Diagnósticos" ng-minlength="3" ng-maxlength="20"
										required autofocus="autofocus" ng-model="setor" />
										<p ng-show="userForm.setor.$invalid && !userForm.setor.$pristine" class="help-block"></p>
										<p ng-show="userForm.setor.$invalid && !userForm.setor.$pristine" class="help-block">Setor é Obrigatório.</p>
										<p ng-show="userForm.setor.$error.minlength" class="help-block">Setor mínimo de 3 caracteres.</p>
                						<p ng-show="userForm.setor.$error.maxlength" class="help-block">Setor máximo de 20 caracteres.</p>
									</div>
							</div>
								...
								<div class="col-sm-2">
									<input type="text" class="form-control" id="ip"
										name="ip" placeholder="Ex: 192.168.102.14" required ng-minlength="3" ng-maxlength="20"
										autofocus="autofocus" ng-model="ip"/>
										<p ng-show="userForm.ip.$invalid && !userForm.ip.$pristine" class="help-block"></p>
										<p ng-show="userForm.ip.$invalid && !userForm.ip.$pristine" class="help-block">Setor é Obrigatório.</p>
										<p ng-show="userForm.ip.$error.minlength" class="help-block">Setor mínimo de 12 caracteres.</p>
                						<p ng-show="userForm.ip.$error.maxlength" class="help-block">Setor máximo de 20 caracteres.</p>
								</div>
								</div>
							...
							<div class="form-group" ng-class="{ 'has-error' : userForm.tipo.$invalid && !userForm.tipo.$pristine }" >
								...
								<div class="col-sm-1">
									<select class="form-control" name="tipo" id="tipo" ng-model="tipo" ng-init="tipo='1'">
								...
								<div class="col-sm-2">
									<input type="text" class="form-control" id="ramal"
										name="ramal" placeholder="Ramal" required ng-minlength="4" ng-maxlength="10"
										autofocus="autofocus" ng-model="ramal"/>
										<p ng-show="userForm.ramal.$invalid && !userForm.ramal.$pristine" class="help-block"></p>
										<p ng-show="userForm.ramal.$invalid && !userForm.ramal.$pristine" class="help-block">Ramal é Obrigatório. Só Pode Conter Números</p>
										<p ng-show="userForm.ramal.$error.minlength" class="help-block">Ramal mínimo de 4 caracteres.</p>
                						<p ng-show="userForm.ramal.$error.maxlength" class="help-block">Ramal máximo de 10 caracteres.</p>
								</div>
								</div>
